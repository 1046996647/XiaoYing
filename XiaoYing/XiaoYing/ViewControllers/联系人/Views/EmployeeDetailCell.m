...
- (void)layoutSubviews
{
    ...
    if ([self.identifier isEqualToString:@"cell1"]) {
        ...
        NSString *iconURL = [NSString replaceString:self.model.FaceURL Withstr1:@"100" str2:@"100" str3:@"c"];
        [_userImg sd_setImageWithURL:[NSURL URLWithString:iconURL]];
        
        NSString *nick = self.model.EmployeeName;
        ...
        _nameLab.text = self.model.EmployeeName;
...
//        _personalLab.text = self.model.;
        ...
        _titleLab.frame = CGRectMake(24, 0, 100, 50);
