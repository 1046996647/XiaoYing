...
@interface NewMemorandumVC ()<UINavigationControllerDelegate,
...
@implementation NewMemorandumVC
...
-(void)btnAction:(UIButton *)btn{
    ...
    [AFNetClient  POST_Path:Create params:dic completed:^(NSData *stringData, id JSONDict) {
