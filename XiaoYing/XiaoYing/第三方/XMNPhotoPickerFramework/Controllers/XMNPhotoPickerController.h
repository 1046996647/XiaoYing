 ...
 */
- (instancetype _Nonnull )initWithMaxCount:(NSUInteger)maxCount andPreviousCount:(NSUInteger)previousCount delegate:(_Nullable id<XMNPhotoPickerControllerDelegate>)delegate NS_DESIGNATED_INITIALIZER;
