...
//        _borderWidth = 0.5f;
        ...
        _cornerRadius = 2.0;
        _titleSize = 14;
        _titleColor = [UIColor colorWithHexString:@"#f99740"];
...
//设置标签数据和代理
- (void)setTagAry:(NSMutableArray *)tagAry delegate:(id)delegate {
    
    NSString *str = [tagAry firstObject];
    str = [str stringByReplacingOccurrencesOfString:@" > " withString:@""];
    [tagAry removeObjectAtIndex:0];
    [tagAry insertObject:str atIndex:0];
...
//            NSLog(@"%ld",j);
            ...
            NSInteger tag = i*iTags.count+j;
            
//            if (tag == 0) {
//                tagTitle = [tagTitle stringByReplacingOccurrencesOfString:@" > " withString:@""];
//            }
...
//                        NSLog(@"%ld",button.tag);
            ...
            if (tag != 0) {
                NSMutableAttributedString *attribute = [[NSMutableAttributedString alloc] initWithString:tagTitle];
                [attribute addAttributes:@{
                                           NSForegroundColorAttributeName : [UIColor colorWithHexString:@"#aaaaaa"],
                                           NSFontAttributeName : [UIFont systemFontOfSize:_titleSize]
                                           }range:NSMakeRange(0, 2)];
                [attribute addAttributes:@{
                                           NSForegroundColorAttributeName : [UIColor colorWithHexString:@"#f99740"],
                                           NSFontAttributeName : [UIFont systemFontOfSize:_titleSize]
                                           }range:NSMakeRange(2, tagTitle.length - 2)];
...
//        titleStr = [titleStr substringToIndex:titleStr.length-3];
//        [button setTitle:titleStr forState:UIControlStateNormal];
    ...
    if (button.tag == 0) {
        ...
        NSMutableAttributedString *attribute = [[NSMutableAttributedString alloc] initWithString:button.currentTitle];
        [attribute addAttributes:@{
                                   NSForegroundColorAttributeName : [UIColor colorWithHexString:@"#aaaaaa"],
                                   NSFontAttributeName : [UIFont systemFontOfSize:_titleSize]
                                   }range:NSMakeRange(0, 2)];
